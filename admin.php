...
if (isset($_SESSION['email']) && $_SESSION['email'] === $hardcoded_admin['email']) {
    $is_hardcoded_admin = true;
}

// Check database admin field for additional admins
...
if (isset($_POST['delete_user']) || isset($_GET['delete_user'])) {
    $user_id_to_delete = (int) ($_POST['delete_user'] ?? $_GET['delete_user']);
...
<body>
    <div class="container dashboard-container admin-container">
        <div class="logo">
            <h1>👑</h1>
        ...
        <div class="admin-header">
            ...
            <p>Monitor users, track system usage, and manage the platform</p>
        </div>
        ...
        <!-- Financial Overview -->
        <div class="admin-section" id="financial">
                            ...
                            <tr>
                                <td>
                                    <div class="user-info">
                                        ...
                                        <?php 
                                        // Show admin badge for hardcoded admin or current user
                                        $is_current_user = $user['id'] == $_SESSION['user_id'];
                                        $is_hardcoded_admin = isset($_SESSION['is_hardcoded_admin']) && $_SESSION['is_hardcoded_admin'];
                                        
                                        if ($is_current_user || $is_hardcoded_admin): ?>
